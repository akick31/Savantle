...
export default function HintDisplay({ guesses, hints }: HintDisplayProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      {hints.length > 0 && (
        <div className="space-y-1.5 pt-2 border-t border-sv-border">
          {hints.map((hint, i) => (
            <div key={i} className="flex items-center gap-1.5 bg-sv-card border border-sv-border rounded-lg px-3 py-2">
