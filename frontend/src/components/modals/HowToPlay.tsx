      ...
      <div className="space-y-3 text-sm text-sv-muted max-h-[70vh] overflow-y-auto">
        ...
        <div className="border-t border-sv-border pt-3">
          ...
          <p className="text-xs text-sv-muted mt-2">
            Early confirmation only applies to team and division. Guessing a player on the correct team reveals team,
            division, and league. Guessing a player in the correct division reveals division and league. A guess that
            only shares the same league or position does not confirm anything early.
          </p>
        </div>

        <div className="border-t border-sv-border pt-3 text-xs text-sv-muted">
          <p className="mb-2">
            A new player is revealed every day at midnight. Players are selected from active 26-man MLB rosters with at
